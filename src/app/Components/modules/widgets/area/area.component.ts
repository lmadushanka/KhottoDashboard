...
export class AreaComponent implements OnInit {
  ...
  constructor(
    private khottoDashboardService: KhottoDashboardService,
  ) {}
  ...
  ngOnInit(): void {
    ...
    this.khottoDashboardService.getSalesReport().subscribe((res) =>{
      // console.log(res);
      var data = res.data;

      for(var i = 0; i < res.data.length; i++){
        this.salesCount.push(Number(data[i].orderCount));
        
      }

      this.sales = this.salesCount;
